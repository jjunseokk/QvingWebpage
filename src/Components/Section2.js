...
import mpaTitle from '../Asset/Image/maptitle.png';
...
const Section2 = () => {
    ...
    // 지역 검색 버튼을 누르면 검색 위치 장소 저장 state
    ...
    },[postMap]); //지역이 바뀔 때 마다 api 호출 재 랜더링
        ...
        <div className="section2-container">
            <div className="form-area">
                <div className="section2-bubble">
                    <img src={mpaTitle} alt=""></img>
                    <img src={speechText} alt=""></img>
                </div>
                <div className="section2-search">
                    ...
                    <button className="mapBtn" onClick={postBtn}><FontAwesomeIcon icon={faMagnifyingGlass} /></button>
                </div>
